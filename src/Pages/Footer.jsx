  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/walter_white_95"
                className="navbar--content instagram-icon"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/shashannkd"
      ...
      <div className="footer--content--container">
        <p className="footer--content--author--name">
          Made by Shashannk Deshpande
        </p>
      </div>
    </footer>
  );
